...
const adminLinks = [
  ...
  },
  {
    ...
    label: 'Liquidity',
    icon: 'M12 2C8 6 4 10.5 4 14.5A8 8 0 0 0 20 14.5C20 10.5 16 6 12 2zm0 18a5.5 5.5 0 0 1-5.5-5.5c0-.28.22-.5.5-.5s.5.22.5.5A4.5 4.5 0 0 0 12 19c.28 0 .5.22.5.5s-.22.5-.5.5z',
  },
];
