...
export interface ConfirmActionModalProps {
  ...
  cancelLabel?: string;
  /** Optional custom content rendered above the footer */
...
export default function ConfirmActionModal({
  ...
  // Mount/unmount the modal so internal state resets cleanly per open.
  if (!isOpen) return null;

  return (
    <ConfirmActionModalInner
      title={title}
...
function ConfirmActionModalInner({
  title,
  description,
  confirmPhrase,
  onConfirm,
